...
XYdatafile = (arcpy.env.workspace + "\\Data\\WeatherStations\\SanJuanWeatherStationMetadata_CoordsXY.csv")
dataTableMerge = (arcpy.env.workspace + "\\Data\\WeatherStations\\SanJuanWeatherStationMetadata_CAIC_WSData01242022.csv")
...
stationDataJoin = arcpy.management.AddJoin(projectedOutPointClass, "CaicName", dataTableMerge, "Station", "KEEP_COMMON")
